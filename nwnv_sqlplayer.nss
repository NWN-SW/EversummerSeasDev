/* team: ---------------------------------------------------------------------
  ...
  The original script was written by Daz for the NWN community.

  Third party scripts, such as those used from neverwintervault or shared with
  us by other server projects, have the file name prefix nwnv_ (neverwintervault).
  ...
  Updated by Fallen Dabus, 2025-8-16

  -------------------------------------------------------------------------- */

/* ai:
    These library functions act as replacements for the usual local functions:
    ...
    * Plus a new function for saving just a vector by itself.
    ...
    These are functions for PC Object persistence only, not for the module saved version.
*/
